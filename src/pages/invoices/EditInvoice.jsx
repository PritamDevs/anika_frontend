...
import HoverButton from "../../components/common/HoverButton.jsx";
...
const EditInvoice = () => {
        ...
        const fetchInvoice = async () => {
            ...
            try {
                ...
                setSelectedCustomer({
                    ...
                    advanceAmount:
                        invoice.customer?.advanceAmount || 0
                });
    ...
    const handleGenerateInvoice = async () => {
        ...
        try {
            const res = await fetch(`${BACKEND_URL}/api/invoices/update/${id}`, {
                method: "PUT",
                headers: {
